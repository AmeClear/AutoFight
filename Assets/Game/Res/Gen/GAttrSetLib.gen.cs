...
namespace GAS.Runtime
{
    public class AS_Fight : AttributeSet
    {
        ...
        /// 护甲
        /// </summary>
        public AttributeBase DefProgress { get; } = new ("AS_Fight", "DefProgress", 0f, CalculateMode.Stacking, (SupportedOperation)31, 0, float.MaxValue);
        ...
        /// 体力
        /// </summary>
        public AttributeBase StamValue { get; } = new ("AS_Fight", "StamValue", 100f, CalculateMode.Stacking, (SupportedOperation)31, 0, float.MaxValue);
